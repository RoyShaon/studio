...
export default function LabelPreview({
  ...
  const renderInstruction = () => {
    ...
    let instruction;
    if (shakeMode === "with") {
        const shakeText = `ঔষধ সেবনের আগে শিশিটিকে হাতের তালুর উপরে দূর হতে সজোরে থেমে থেমে <span class="${highlightStyle}">${bnShakeCount}</span> বার ঝাঁকি দিয়ে <span class="${highlightStyle}">${bnDrops}</span> ফোঁটা ঔষধ <strong class="${highlightStyle}">১ কাপ</strong> ঠান্ডা জলের সাথে চামচ দিয়ে ভালোভাবে মিশিয়ে`;
